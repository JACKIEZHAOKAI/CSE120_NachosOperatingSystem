 ...
 */
public class ThreadedKernel extends nachos.machine.Kernel {
	/**
	...
	//	System.out.print("init now ");
		...
		if (fileSystemName != null)
			fileSystem = (nachos.machine.FileSystem) Lib.constructObject(fileSystemName);
...
//		// added tests
//		//##############################################
//		Alarm.selfTest();		//test for PA1 part1
//
//		Condition2.selfTest();	//test for PA1 part3 4
//
//		SquadMatch.selfTest();	//test for PA1 part5
